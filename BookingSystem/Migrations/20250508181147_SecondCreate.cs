        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Travelagent = table.Column<int>(type: "int", nullable: false),
                    image = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "https://via.placeholder.com/150")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodReview = table.Column<int>(type: "int", nullable: true),
                    FlightReview = table.Column<int>(type: "int", nullable: true),
                    HotelReview = table.Column<int>(type: "int", nullable: true),
                    TravelAgentReview = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
